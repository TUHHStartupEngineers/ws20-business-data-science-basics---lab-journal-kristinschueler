...
Location<- merge(x = Covid_data, y = world,
                 by = "region",
                 all.x = T,
                 all.y = T)
...
Location%>%
  ...
  geom_map(aes(map_id = geoId), map = world)+
...
Letztlich habe ich fast alle Aufgaben gemeistert mit nicht unerheblichem Zeitaufwand. Das war einer der Gründe, weshalb ich mich zuletzt auch aus dem Nachfolgekurs "Machine Learning" wieder ausgetragen habe. 
